...
_Generated: 2026-04-11T11:11:49.066Z_
...
Workspace `mcp.json` _(folder: potfolio)_

- **c:\Users\subha\OneDrive\Desktop\potfolio\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\subha\AppData\Roaming\Code\User\mcp.json** — _File missing_
